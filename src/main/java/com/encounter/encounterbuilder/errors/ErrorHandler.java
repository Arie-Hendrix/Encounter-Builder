package com.encounter.encounterbuilder.errors;
...
public class ErrorHandler {
  ...
  @ResponseStatus(code = HttpStatus.BAD_REQUEST)
  private Map<String, Object> handleConstraintViolationException(ConstraintViolationException e, WebRequest webRequest){
    return createExceptionMessage(e, HttpStatus.BAD_REQUEST, webRequest, LogStatus.MESSAGE_ONLY);
  }
